...
nukes.t6 = {['Earth']="Stone VI",   ['Water']="Water VI",   ['Air']="Aero VI",  ['Fire']="Fire VI", ['Ice']="Blizzard VI",  ['Lightning']="Thunder VI", ['Light']="Thunder VI", ['Dark']="Blizzard VI"}
...
function updateRunspeedGear(value)    
    if not value then
        if use_UI == true then
            ...
            windower.add_to_chat(8,"----- Locking Off Herald's Gaiters -----")   
        end
        enable('feet')
        idle()
    else
