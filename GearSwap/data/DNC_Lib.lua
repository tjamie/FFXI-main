...
dance_maps = {
    ...
    ['Aspir Samba']='samba',['Aspir Samba II']='samba',
    ['Haste Samba']='samba',
    ['Curing Waltz']='waltz',['Curing Waltz II']='waltz',['Curing Waltz III']='waltz',['Curing Waltz IV']='waltz',
    ['Divine Waltz']='waltz',['Divine Waltz II']='waltz',
}
...
\cs(255, 255, 64)${key_bind_mainweapon} \cs(200, 200, 200)Main Weapon:\cr \cs(125,125,255)${player_current_mainweapon|Tauret}
\cs(255, 255, 64)${key_bind_subweapon} \cs(200, 200, 200)Sub Weapon:\cr \cs(125,125,255)${player_current_subweapon|Gleti's Knife}
]]
...
function hud_command(command) 
    ...
    if #commandArgs:split(' ') >= 2 then
        ...
        -- if commandArgs[1]:lower() == "dancer" then
        --     if commandArgs[2].lower() == "quickstep" or commandArgs[2].lower() == "boxstep" or commandArgs[2].lower() == "stutterstep" or commandArgs[2].lower() == "featherstep" then
        --         local prestoRecast = windower.ffxi.get_spell_recasts()[245]
        --     end
        -- end
    end
end
...
function precast(spell)    
    ...
    elseif spell.type == "Step" then
        local prestoCooldown = ability_recasts[236]
...
function updateRunspeedGear(value)    
    if not value or value == "OFF" then
        ...
        enable('feet')
        if value == "Crackows" then
            equip({feet = "Tandava Crackows"})
        end
        disable('feet')
        idle()
    end
