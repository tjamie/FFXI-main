...
idleModes = M('dt')
meleeModes = M('normal', 'accuracy', 'hybrid', 'th')
nukeModes = M('normal', 'acc') -- not used but i can't be arsed to edit right now
...
function get_sets()
    ...
    EMPY.Legs		=	""
    EMPY.Feet		=	""
    EMPY.Earring    =   "Skulk. Earring +1"

    -- Capes:
    -- Sucellos's And such, add your own.
    THFCape = {}
    THFCape.TP		=	{ name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','DEX+10','"Dbl.Atk."+10','Damage taken-5%',}}
    THFCape.STR     =   THFCape.TP
    THFCape.DEX     =   THFCape.TP
    THFCape.INT     =   THFCape.TP
	-- SETS
    ...
    sets.me.melee.thdw = set_combine(sets.me.melee.normaldw,{
        -- wonky until we get empy boots
        hands=RELIC.Hands, --TH+3
    ...
    sets.me["Savage Blade"] = {
        ...
        waist="Sailfi Belt +1",
        left_ear="Sherida Earring",
        right_ear="Moonshade Earring", --TP Bonus+250
        left_ring="Epaminondas's Ring",
        right_ring="Sroda Ring",
        back=THFCape.STR,
	}
    sets.me["Rudra's Storm"] = set_combine(sets.me["Savage Blade"], {
        ammo="Coiste Bodhar",
        head="Nyame Helm",
        body="Nyame Mail",
        hands="Nyame Gauntlets",
    ...
    sets.midcast["Diaga"] = set_combine(sets.midcast.casting,{
        hands=RELIC.Hands, --TH+3
        waist="Chaac Belt", --TH+1
        ammo="Per. Lucky Egg", --TH+1
    })
